...
const ImageModal = ({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/90 backdrop-blur-sm p-2 sm:p-4">
      <div className="relative max-w-[95vw] max-h-[95vh] sm:max-w-[90vw] sm:max-h-[90vh]">
        <button
          onClick={onClose}
          className="absolute -top-8 sm:-top-12 right-0 z-10 p-2 text-white hover:text-gray-300 transition-colors bg-black/50 rounded-full backdrop-blur-sm"
        >
