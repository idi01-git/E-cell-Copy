...
export function BackgroundPaths({
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-background pt-8 md:pt-24 lg:pt-32">
      ...
      {showGradientOrb && (
        ...
        >
          <div className="absolute inset-0 rounded-full bg-gradient-to-r from-yellow-400/30 via-yellow-300/20 to-yellow-100/10 blur-3xl" />
        </motion.div>
      )}
        ...
        >
          ...
          <motion.div
            className={`
                            ...
                            ${
                              titleBackground
                                ? `p-8 sm:p-12 md:p-16 rounded-3xl ${getBackgroundClasses()}`
                                : ""
                            }
                            relative
                        `}
          ...
          >
                  ...
                  {word.split("").map((letter, letterIndex) => (
                    <motion.span
                      ...
                      className="inline-block text-transparent bg-clip-text 
                                                bg-gradient-to-br from-yellow-600 via-yellow-400 to-yellow-200 
                                                dark:from-yellow-300 dark:via-yellow-200 dark:to-yellow-100
                                                drop-shadow-2xl"
                    >
                      {letter}
                    </motion.span>
            ...
            {/* Animated underline */}
            <motion.div
              className="mt-8 mx-auto h-1 bg-gradient-to-r from-transparent via-yellow-400 to-transparent dark:via-yellow-200"
              initial={{ width: 0 }}
              animate={{ width: "100%" }}
          ...
          {titleBackground && (
            ...
            >
              ...
              {[...Array(6)].map((_, i) => (
                <motion.div
                  key={i}
                  className="absolute w-2 h-2 bg-yellow-300/30 dark:bg-yellow-200/20 rounded-full"
                  style={{
                    left: `${20 + i * 15}%`,
                    top: `${30 + (i % 2) * 40}%`,
                  }}
